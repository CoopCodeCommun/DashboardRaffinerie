                                  ...
                                  <div class="container case case_clair h-100 ">
                                   ...
                                   <OuvrirFermer title="prestation internes" class="case titre">
                                     <div class="row">
                                      <!-- prévisionnel -->
                                      <div class="col-4">
                                          <div><CreationTableau :titre="titre_prev_prestations_internes" :rows="rows_prev_prestations_internes" :columns="columns_prev_prestations_internes" :showFooter="true" /></div>   
                                      </div>                          
                                      <!-- réel -->
                                       <div class="col-8">                           
                                         <div><CreationTableau :titre="titre_reel_prestations_internes" :rows="rows_reel_prestations_internes" :columns="columns_reel_prestations_internes" :showFooter="true" /></div>
                                       </div> 
                                     </div>
                                   </OuvrirFermer>
                                   ...
                                   <OuvrirFermer title="Prestations externes / achats" class="case titre">
                                     <div class="row">
                                      <!-- prévisionnel -->
                                      <div class="col-4">
                                          <div><CreationTableau :titre="titre_prev_prestations_externes" :rows="rows_prev_prestations_externes" :columns="columns_prev_prestations_externes" :showFooter="true" /></div>   
                                      </div>                          
                                      <!-- réel -->
                                       <div class="col-8">                           
                                         <div><CreationTableau :titre="titre_reel_prestations_externes" :rows="rows_reel_prestations_externes" :columns="columns_reel_prestations_externes" :showFooter="true" /></div>
                                       </div> 
                                     </div>
                                   </OuvrirFermer>
                                   ...
                                   <OuvrirFermer title="Dépenses interne" class="case titre">
                                     <div class="row">
                                      <!-- prévisionnel -->
                                      <div class="col-4">
                                          <div><CreationTableau :titre="titre_prev_dépenses_internes" :rows="rows_prev_dépenses_internes" :columns="columns_prev_dépenses_internes" :showFooter="true" /></div>   
                                      </div>                          
                                      <!-- réel -->
                                       <div class="col-8">                           
                                         <div><CreationTableau :titre="titre_reel_dépenses_internes" :rows="rows_reel_dépenses_internes" :columns="columns_reel_dépenses_internes" :showFooter="true" /></div>
                                       </div> 
                                     </div>
                                   </OuvrirFermer>
                                  ...
                                  <OuvrirFermer title="Recettes" class="case titre">
                                   ...
                                   <OuvrirFermer title="Subvention / appel à projets" class="case titre">
                                     <div class="row">
                                      <!-- prévisionnel -->
                                      <div class="col-5">
                                          <div><CreationTableau :titre="titre_prev_subvention" :rows="rows_prev_subvention" :columns="columns_prev_subvention" :showFooter="true" /></div>
                                      </div>                          
                                      <!-- réel -->
                                       <div class="col-7">                           
                                         <div><CreationTableau :titre="titre_reel_subvention" :rows="rows_reel_subvention" :columns="columns_reel_subvention" :showFooter="true" /></div>
                                       </div> 
                                     </div>
                                   </OuvrirFermer>
                                   ...
                                   <OuvrirFermer title="Prestations" class="case titre">
                                     <div class="row">
                                      <!-- prévisionnel -->
                                      <div class="col-5">
                                          <div><CreationTableau :titre="titre_prev_prestations" :rows="rows_prev_prestations" :columns="columns_prev_prestations" :showFooter="true" /></div>
                                      </div>                          
                                      <!-- réel -->
                                       <div class="col-7">                           
                                         <div><CreationTableau :titre="titre_reel_prestations" :rows="rows_reel_prestations" :columns="columns_reel_prestations" :showFooter="true" /></div>
                                       </div> 
                                     </div>
                                   </OuvrirFermer>
                                   ...
                                   <OuvrirFermer title="ventes" class="case titre">
                                     <div class="row">
                                      <!-- prévisionnel -->
                                      <div class="col-5">
                                          <div><CreationTableau :titre="titre_prev_ventes" :rows="rows_prev_ventes" :columns="columns_prev_ventes" :showFooter="true" /></div>
                                      </div>                          
                                      <!-- réel -->
                                       <div class="col-7">                           
                                         <div><CreationTableau :titre="titre_reel_ventes" :rows="rows_reel_ventes" :columns="columns_reel_ventes" :showFooter="true" /></div>
                                       </div> 
                                     </div>
                                   </OuvrirFermer>
                                   ...
                                   <OuvrirFermer title="Recettes internes" class="case titre">
                                     <div class="row">
                                      <!-- prévisionnel -->
                                      <div class="col-5">
                                          <div><CreationTableau :titre="titre_prev_recettes_internes" :rows="rows_prev_recettes_internes" :columns="columns_prev_recettes_internes" :showFooter="true" /></div>
                                      </div>                          
                                      <!-- réel -->
                                       <div class="col-7">                           
                                         <div><CreationTableau :titre="titre_reel_recettes_internes" :rows="rows_reel_recettes_internes" :columns="columns_reel_recettes_internes" :showFooter="true" /></div>
                                       </div> 
                                     </div>
                                   </OuvrirFermer>
                                 </div>  
