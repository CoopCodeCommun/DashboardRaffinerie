...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('uuid', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, unique=True)),
                ('attachment_uuid', models.UUIDField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('uuid', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, unique=True)),
                ('iban_uuid', models.UUIDField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.CharField(blank=True, max_length=150, null=True, verbose_name='id parent')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('M', 'Memberships'), ('B', 'Beneficiaires')], default='M', max_length=1, verbose_name='type')),
            ],
        ),
        migrations.CreateModel(
            name='RealCost',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('uuid', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, unique=True)),
                ('api_uuid', models.UUIDField(blank=True, null=True, verbose_name='api pk ')),
                ...
                ('reference', models.CharField(blank=True, max_length=50, null=True, verbose_name='Numeré de facture')),
                ('label_fournisseur', models.CharField(blank=True, max_length=70, null=True, verbose_name='fournisseur')),
                ('status', models.CharField(blank=True, max_length=25, null=True, verbose_name='status')),
                ('note', models.TextField(blank=True, null=True, verbose_name='Description')),
                ('attachment_ids', models.TextField(blank=True, default=[], null=True, verbose_name='Pièce joint')),
                ...
                ('category', models.CharField(blank=True, max_length=25, null=True, verbose_name='catégorie')),
                ('beneficiary', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='beneficiary_transactions', to='dashboard_app.qontocontact', verbose_name='Bénéficiaire')),
                ('iban', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='iban_transaction', to='dashboard_app.iban', verbose_name='iban')),
                ('initiator', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='initiator_transactions', to='dashboard_app.qontocontact', verbose_name='Initiateur')),
            ],
        ),
    ]
